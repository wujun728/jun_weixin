...
public class PageInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation)
        ...
        while (metaObject.hasGetter("h")) {
            ...
            metaObject = MetaObject.forObject(object, DEFAULT_OBJECT_FACTORY, DEFAULT_OBJECT_WRAPPER_FACTORY,DEFAULT_REFLECTORFACTORY);
        }
        // 分离最后一个代理对象的目标类
	...
	private Page getParameterPage(MetaObject obj) {
        ...
        if(boundSql.getParameterObject().getClass() == DefaultSqlSession.StrictMap.class) {
            ...
            Set<Entry> entrySet = parameterObject.entrySet();
