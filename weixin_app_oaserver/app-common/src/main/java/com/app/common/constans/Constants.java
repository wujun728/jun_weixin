package com.app.common.constans;
...
public class Constants {
	...
	public static final List<Map<String, Object>> getFileMyNoteDefaultFolder(){
		...
		newnotes.put("icon", "../../assets/images/my-file-icon.png");//图标
		beans.add(newnotes);
    ...
    public static String getActModleUpStateMationList(){
        return ACT_MODLE_UP_STATE_LIST;
    }
