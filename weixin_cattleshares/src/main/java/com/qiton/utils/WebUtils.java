...
/**
 * 
 * 网络工具类：从TaobaoSDK中提取，目前主要用于发送中文短信.
 * 
 * @author youblade
 * @since 0.1
 * @created 2014年9月27日 下午5:36:43
 */
public abstract class WebUtils {

    private static final String DEFAULT_CHARSET = Constant.UTF_8;
     ...
     * @throws IOException
     */
    public static String _doPost(String url, String ctype, byte[] content, int connectTimeout, int readTimeout)
        throws IOException {
