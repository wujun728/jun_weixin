...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resource/css/skins/_all-skins.css">
</head>
<body class="hold-transition skin-blue sidebar-mini" style="overflow:hidden;">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="${pageContext.request.contextPath}/resource/img/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <div class="sidebar">
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="${pageContext.request.contextPath}/resource/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                    </div>
    ...
    <script src="${pageContext.request.contextPath}/resource/js/jquery/jQuery-2.2.0.min.js"></script>
