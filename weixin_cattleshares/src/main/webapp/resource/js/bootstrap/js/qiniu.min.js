function QiniuJsSDK() {
    ...
    this.uploader = function(b) {
        ...
        a.uptoken_url = b.uptoken_url,
        a.token = "",
        a.key_handler = "function" == typeof b.init.Key ? b.init.Key: "",
        ...
        function(c, d) {
            ...
            if (g = g || c.settings && c.settings.chunk_size, "html5" === j.runtime && g) if (d.size < g) e(c, d, a.key_handler);
            else {
                var h = localStorage.getItem(d.name),
                k = g;
                h && (h = JSON.parse(h), d.loaded = h.offset, d.percent = h.percent, f = h.ctx, h.offset + k > d.size && (k = d.size - h.ctx)),
                c.setOption({
                    url: "http://up.qiniu.com/mkblk/" + k,
                    multipart: !1,
                    chunk_size: g,
                    headers: {
        ...
        function(b, c, d) {
            ...
            h = h || b.settings && b.settings.chunk_size,
            h > g && b.setOption({
                url: "http://up.qiniu.com/mkblk/" + g
            }),
        ...
        function(c) {
            return function(d, e, g) {
                    ...
                    if (b.downtoken_url) {
                        ...
                        g.onreadystatechange = function() {
                            if (4 === g.readyState) if (200 === g.status) {
                                ...
                                var i = {};
                                plupload.extend(i, a.parseJSON(f), b),
                                c && c(d, e, JSON.stringify(i))
                ...
                if (f = f ? f: k.ctx) {
                    ...
                    var q = "http://up.qiniu.com/mkfile/" + e.size + l + o,
                    r = a.createAjax();
                    r.open("POST", q, !0),
                    r.setRequestHeader("Content-Type", "text/plain;charset=UTF-8"),
                    r.setRequestHeader("Authorization", "UpToken " + a.token),
