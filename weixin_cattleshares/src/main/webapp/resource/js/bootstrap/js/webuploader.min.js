/* WebUploader 0.1.0 */ ! function(a) {
	...
	c("base", ["jQuery"], function(b) {
			...
			function e(a) {
				...
				a.label = a.label || a.container.text() || "閫夋嫨鏂囦欢", a.button = f(a.button || document.createElement("div")), a.button.text(a.label), a.container.html(a.button), c.call(this, "FilePicker", !0)
			}
			var f = b.$;
			return e.options = {
				button: null,
			...
			return a.$.extend(b.options, {
				...
				addButton: function(b) {
					var d, e, f, g = this,
						h = g.options,
						i = h.accept;
					if(b) return f = a.Deferred(), "string" == typeof b && (b = {
						id: b
					}), d = $.extend({}, b, {
			...
			return b.register("Transport", {
				...
				send: function() {
					...
					d.connectRuntime(e.ruid), c.sendAsBinary ? (f += (/\?/.test(f) ? "&" : "?") + $.param(b._formData), a = e.uid) : ($.each(b._formData, function(a, b) {
						d.exec("append", a, b)
					}), d.exec("appendBlob", c.fileVar, e.uid, c.filename || b._formData.name || "")), this._setRequestHeader(d, c.headers), d.exec("send", {
						method: c.method,
						url: f
					}, a)
				},
			...
			return {
				createObjectURL: b && b.createObjectURL,
				revokeObjectURL: b && b.revokeObjectURL,
				dataURL2Blob: function(a) {
					...
					return f = g[0].split(":")[1].split(";")[0], new Blob([d], {
						type: f
					})
				},
					...
					if(!(b.byteLength < 6)) {
						...
						if(65496 === h.getUint16(0)) {
							for(; j > i && (d = h.getUint16(i), d >= 65504 && 65519 >= d || 65534 === d) && (e = h.getUint16(i + 2) + 2, !(i + e > h.byteLength));) {
								if(f = a.parsers[d], !c && f)
									for(g = 0; g < f.length; g += 1) f[g].call(a, h, i, e, l);
								i += e, k = i
							}
				...
				init: function() {
					...
					b.onload = function() {
						a._info = {
							...
							width: this.width,
							height: this.height
						}, !a._metas && ~"image/jpegimage/jpg".indexOf(a.type) ? c.parse(a._blob, function(b, c) {
			...
			f.extend(b.options, {
				...
				_doSend: function(b) {
					var c = this,
						...
						i = b.file,
						j = new d(g),
						k = f.extend({}, g.formData),
						l = f.extend({}, g.headers);
