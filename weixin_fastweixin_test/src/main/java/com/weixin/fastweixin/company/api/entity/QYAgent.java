...
public class QYAgent extends BaseModel {
	 ...
	 */
	public QYAgent(String agentId, String name, String description, String redirectDomain, Integer reportLocationFlag, Integer isReportUser,
	...
	public QYAgent(String agentId, String name, String squareLogoUrl, String roundLogoUrl, String description, Map<String, Object> allowUserInfos,
			Map<String, Object> allowPartys, Map<String, Object> allowTags, Integer close, String redirectDomain, Integer reportLocationFlag,
			Integer isReportUser, Integer isReportEnter) {
	...
	public String toString() {
		return "QYAgent{" + "agentId='" + agentId + '\'' + ", name='" + name + '\'' + ", squareLogoUrl='" + squareLogoUrl + '\'' + ", roundLogoUrl='"
				+ roundLogoUrl + '\'' + ", description='" + description + '\'' + ", allowUserInfos=" + allowUserInfos + ", allowPartys=" + allowPartys
				+ ", allowTags=" + allowTags + ", close=" + close + ", redirectDomain='" + redirectDomain + '\'' + ", reportLocationFlag="
				+ reportLocationFlag + ", isReportUser=" + isReportUser + ", isReportEnter=" + isReportEnter + '}';
	}
