...
public class QYUser extends BaseModel {
	...
	public QYUser(String userId, String name, Integer[] department, String position, String mobile, String gender, String email, String weixinid,
			Map<String, Object> extattr) {
		this.userId = userId;
		this.name = name;
	...
	public QYUser(String userId, String name, Integer[] department, String position, String mobile, String gender, String email, String weixinid,
			String avatar, Integer status, Map<String, Object> extattr) {
		this.userId = userId;
		this.name = name;
		this.position = position;
		this.mobile = mobile;
