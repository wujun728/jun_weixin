...
public class GetQYAgentInfoResponse extends BaseResponse {
	...
	public QYAgent getQyAgent() {
		return new QYAgent(agentId, name, squareLogoUrl, roundLogoUrl, description, allowUserInfos, allowPartys, allowTags, close, redirectDomain,
				reportLocationFlag, isReportUser, isReportEnter);
	}
