...
import com.weixin.fastweixin.company.handle.QYEventHandle;
import com.weixin.fastweixin.company.handle.QYMessageHandle;
import com.weixin.fastweixin.company.message.req.QYBaseEvent;
import com.weixin.fastweixin.company.message.req.QYBaseReq;
import com.weixin.fastweixin.company.message.req.QYBaseReqMsg;
import com.weixin.fastweixin.company.message.req.QYBatchJobEvent;
import com.weixin.fastweixin.company.message.req.QYEnterAgentEvent;
import com.weixin.fastweixin.company.message.req.QYEventType;
import com.weixin.fastweixin.company.message.req.QYImageReqMsg;
import com.weixin.fastweixin.company.message.req.QYLocationEvent;
import com.weixin.fastweixin.company.message.req.QYLocationReqMsg;
import com.weixin.fastweixin.company.message.req.QYMenuEvent;
import com.weixin.fastweixin.company.message.req.QYReqType;
import com.weixin.fastweixin.company.message.req.QYScanCodeEvent;
import com.weixin.fastweixin.company.message.req.QYSendPicInfoEvent;
import com.weixin.fastweixin.company.message.req.QYTextReqMsg;
import com.weixin.fastweixin.company.message.req.QYVideoReqMsg;
import com.weixin.fastweixin.company.message.req.QYVoiceReqMsg;
import com.weixin.fastweixin.company.message.resp.QYBaseRespMsg;
import com.weixin.fastweixin.company.message.resp.QYTextRespMsg;
...
public abstract class QYWeixinSupport {
	...
	public void bindServer(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			String echoStr = pc.verifyUrl(request.getParameter("msg_signature"), request.getParameter("timestamp"), request.getParameter("nonce"),
	...
	public String processRequest(HttpServletRequest request) {
		...
		if (msgType.equals(QYReqType.EVENT)) {
			...
			} else if (QYEventType.PICPHOTOORALBUM.equals(eventType) || QYEventType.PICSYSPHOTO.equals(eventType)
					|| QYEventType.PICWEIXIN.equals(eventType)) {
				String eventKey = (String) reqMap.get("EventKey");
