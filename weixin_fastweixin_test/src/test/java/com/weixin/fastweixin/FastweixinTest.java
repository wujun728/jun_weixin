...
import com.weixin.fastweixin.api.CustomAPI;
import com.weixin.fastweixin.api.DataCubeAPI;
import com.weixin.fastweixin.api.JsAPI;
import com.weixin.fastweixin.api.MaterialAPI;
import com.weixin.fastweixin.api.MediaAPI;
import com.weixin.fastweixin.api.MenuAPI;
import com.weixin.fastweixin.api.MessageAPI;
import com.weixin.fastweixin.api.OauthAPI;
import com.weixin.fastweixin.api.SystemAPI;
import com.weixin.fastweixin.api.UserAPI;
...
import com.weixin.fastweixin.api.entity.MenuButton;
import com.weixin.fastweixin.api.enums.MaterialType;
import com.weixin.fastweixin.api.enums.MediaType;
import com.weixin.fastweixin.api.enums.MenuType;
import com.weixin.fastweixin.api.enums.OauthScope;
import com.weixin.fastweixin.api.enums.ResultType;
import com.weixin.fastweixin.api.response.DownloadMaterialResponse;
import com.weixin.fastweixin.api.response.DownloadMediaResponse;
import com.weixin.fastweixin.api.response.GetArticleSummaryResponse;
import com.weixin.fastweixin.api.response.GetArticleTotalResponse;
import com.weixin.fastweixin.api.response.GetGroupsResponse;
import com.weixin.fastweixin.api.response.GetMaterialListResponse;
import com.weixin.fastweixin.api.response.GetMaterialTotalCountResponse;
import com.weixin.fastweixin.api.response.GetMenuResponse;
import com.weixin.fastweixin.api.response.GetSendMessageResponse;
import com.weixin.fastweixin.api.response.GetSignatureResponse;
import com.weixin.fastweixin.api.response.GetUserCumulateResponse;
import com.weixin.fastweixin.api.response.GetUserInfoResponse;
import com.weixin.fastweixin.api.response.GetUserReadHourResponse;
import com.weixin.fastweixin.api.response.GetUserReadResponse;
import com.weixin.fastweixin.api.response.GetUserShareHourResponse;
import com.weixin.fastweixin.api.response.GetUserShareResponse;
import com.weixin.fastweixin.api.response.GetUserSummaryResponse;
import com.weixin.fastweixin.api.response.GetUsersResponse;
import com.weixin.fastweixin.api.response.OauthGetTokenResponse;
import com.weixin.fastweixin.api.response.UploadMaterialResponse;
import com.weixin.fastweixin.api.response.UploadMediaResponse;
import com.weixin.fastweixin.message.MpNewsMsg;
...
public class FastweixinTest {
	...
	private void createMenu(ApiConfig config) {
		...
		sub1.setUrl(
				"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxafb7b8f9457b5d50&redirect_uri=http://121.40.140.41/erhuluanzi/app/testGet&response_type=code&scope=snsapi_userinfo&state=123#wechat_redirect");
	...
	public void uploadNewsMaterial() {
		MaterialAPI materialAPI = new MaterialAPI(config);
		Article article = new Article("VnzJFSwv05ezhWSlU3kV6fmFYxHXaIHQMxx2SjX87fg", "测试", "测试", "http://www.baidu.com", "测试新闻。无意义", "测试新闻。无意义",
	...
	public void downloadMaterial() {
		...
		// materialAPI.downloadMaterial("VnzJFSwv05ezhWSlU3kV6fmFYxHXaIHQMxx2SjX87fg",
		// MaterialType.IMAGE);
		// try {
		// FileOutputStream outputStream = new FileOutputStream(new
		// File("/Users/jileilei/Desktop/2.jpg"));
		...
		// 此处是下载的图文信息
		// DownloadMaterialResponse response =
		// materialAPI.downloadMaterial("7jek93ZJrpO1nQgj_fbB2c4D8CNMMteoOc8Xbu9NSa0",
		// MaterialType.NEWS);
