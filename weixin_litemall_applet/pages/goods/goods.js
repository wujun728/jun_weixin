...
Page({
  ...
  getGoodsInfo: function() {
    ...
    util.request(api.GoodsDetail, {
      ...
      if (res.code===200) {
        ...
        let _specificationList = res.data.productAttributeValueList
        ...
        that.setData({
          ...
          attribute: res.data.productAttributeValueList,
          issueList: res.data.issue,

          brand: res.data.brand,
          specificationList: res.data.specificationList,
          productList: res.data.typeGoodsList,
          userHasCollect: res.data.favorite,
  ...
  getGoodsRelated: function() {
    let that = this;
    util.request(api.goods.consultList, {
      id: that.data.id
    }).then(function(res) {
      if (res.code===200) {
        that.setData({
