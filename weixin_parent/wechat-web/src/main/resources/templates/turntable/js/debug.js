...
(function(WIN, DOC) {
  ...
  Debug = (function() {
    ...
    parentCss = ["-webkit-overflow-scrolling:touch", "overflow:auto", "line-height:0.8", "z-index:5000", "position:fixed", "left:0", "top:0", "font-size:1.5em", "background:rgba(0,0,0,.8)", "color:#fff", "width:100%", "padding-bottom:" + parentBottom + "px"].concat(publicCss);
