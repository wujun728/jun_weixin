...
#ifndef _H_accesstoken_
#define _H_accesstoken_
...
_WINDLL_FUNC int DSCINIT_accesstoken( accesstoken *pst );

#include "fasterjson.h"

_WINDLL_FUNC int DSCSERIALIZE_JSON_accesstoken( accesstoken *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_JSON_DUP_accesstoken( accesstoken *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_accesstoken( char *encoding , char *buf , int *p_len , accesstoken *pst );
