...
namespace HttpSocket
{
    public static class MimeMapping
    {
        ...
        {
            MimeMapping._mimeMappingTable.Add(new KeyValue() { Key = extension, Value = MimeType });
        }
        ...
        public static string GetMimeMappingByFile(string FileName)
        {
            ...
            {
                text = GetMimeMapping(FileName.Substring(num));
            }
            return text;
        }
        ...
        public static string GetMimeMapping(string ext)
        {
            ...
            var text = (from o in MimeMapping._mimeMappingTable where o.Key == ext select o.Value).FirstOrDefault();
            if (text == null)
            {
        ...
        {
            var text = (from o in MimeMapping._mimeMappingTable where o.Value == type select o.Key).FirstOrDefault();
            if (text == null)
            {
                return ".null";
            }
        ...
        static MimeMapping()
        {
            ...
            MimeMapping.AddMimeMapping(".mp3", "audio/mp3");
