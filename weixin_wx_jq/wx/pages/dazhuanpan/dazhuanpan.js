...
Page({
  ...
  data: {
    Jack_pots: [ //奖项区间 ，360度/奖项个数 ，一圈度数0-360，可自定义设置
        ...
        { startAngle: 1, endAngle: 51, val: "未中奖"}, 
        { startAngle: 52, endAngle: 102, val: "6等奖" },
        { startAngle: 103, endAngle: 153, val: "5等奖" },
        { startAngle: 154, endAngle: 203, val: "4等奖" },
        { startAngle: 204, endAngle: 251, val: "3等奖" },
        { startAngle: 252, endAngle: 307, val: "2等奖" },
        { startAngle: 307, endAngle: 360, val: "1等奖" }
      ],
      is_play: false,//是否在运动中，避免重复启动bug
      available_num: 3,//可用抽奖的次数，可自定义设置或者接口返回
      start_angle: 0,//转动开始时初始角度=0位置指向正上方，按顺时针设置，可自定义设置
      base_circle_num: 8,//基本圈数，就是在转到（最后一圈）结束圈之前必须转够几圈 ，可自定义设置
      ...
      end_speed: 16,//最后转速，在结束圈的转速，可自定义设置
