...
Page({
  ...
  data: {
    ...
    canvas_width: 300,//画布宽度，可自定义设置
    canvas_height: 100,//画布高度，可自定义设置
    result_arr: [//奖项池，可自定义设置
      { src: "../../images/guaguaka2/1.jpg", val: "未中奖" },
      { src: "../../images/guaguaka2/2.jpg", val: "电视机" },
      { src: "../../images/guaguaka2/3.jpg", val: "电冰箱" },
      { src: "../../images/guaguaka2/4.jpg", val: "缝纫机" },
      { src: "../../images/guaguaka2/5.jpg", val: "热水器" }
    ],
  ...
  getVal: function () {
    ...
    //依据随机参数设置实际奖项图片地址  
    this.setData({ result_src: this.data.result_arr[rad].src });
    //依据随机参数设置实际奖项值
    this.setData({ result_val: this.data.result_arr[rad].val });
  },
  //初始化画布
  initCanvas: function () {
    //设置遮盖颜色
